...
#' filename: /Users/mark/dev/R/autoGoogleAPI/googleclouduseraccountsbeta.auto/R/clouduseraccounts_functions.R
#' api_json: api_json
#' 
#' @details 
...
globalAccountsOperations.delete <- function(project, operation) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/operations/%s", 
        project, operation)
...
globalAccountsOperations.list <- function(project, filter = NULL, maxResults = NULL, 
    ...
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/operations", 
        project)
...
groups.addMember <- function(GroupsAddMemberRequest, project, groupName) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/groups/%s/addMember", 
        project, groupName)
...
groups.delete <- function(project, groupName) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/groups/%s", 
        project, groupName)
...
groups.insert <- function(Group, project) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/groups", 
        project)
...
groups.removeMember <- function(GroupsRemoveMemberRequest, project, groupName) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/groups/%s/removeMember", 
        project, groupName)
...
linux.getAuthorizedKeysView <- function(project, zone, user, instance, login = NULL) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/zones/%s/authorizedKeysView/%s", 
        project, zone, user)
...
linux.getLinuxAccountViews <- function(project, zone, instance, filter = NULL, maxResults = NULL, 
    orderBy = NULL, pageToken = NULL) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/zones/%s/linuxAccountViews", 
        project, zone)
...
users.addPublicKey <- function(PublicKey, project, user) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/users/%s/addPublicKey", 
        project, user)
...
users.delete <- function(project, user) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/users/%s", 
        project, user)
...
users.insert <- function(User, project) {
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/users", 
        project)
...
users.removePublicKey <- function(project, user, fingerprint) {
    ...
    url <- sprintf("https://www.googleapis.com/clouduseraccounts/beta/projects/%s/global/users/%s/removePublicKey", 
        project, user)
