# googleclouduseraccountsbeta.auto
...
```r
library(googleAuthR)
library(googleclouduseraccountsbeta.auto)
...
gar_auth()
```
 See the documentation for the package starting at `?googleclouduseraccountsbeta.auto`
## Useage
