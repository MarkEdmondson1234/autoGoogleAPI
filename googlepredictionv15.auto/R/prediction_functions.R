...
hostedmodels.predict <- function(Input, hostedModelName) {
    url <- sprintf("https://www.googleapis.com/prediction/v1.5/hostedmodels/%s/predict", 
        hostedModelName)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
trainedmodels.analyze <- function(id) {
    url <- sprintf("https://www.googleapis.com/prediction/v1.5/trainedmodels/%s/analyze", 
        id)
...
trainedmodels.delete <- function(id) {
    url <- sprintf("https://www.googleapis.com/prediction/v1.5/trainedmodels/%s", 
        id)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
trainedmodels.list <- function(maxResults = NULL, pageToken = NULL) {
...
trainedmodels.predict <- function(Input, id) {
    url <- sprintf("https://www.googleapis.com/prediction/v1.5/trainedmodels/%s/predict", 
        id)
