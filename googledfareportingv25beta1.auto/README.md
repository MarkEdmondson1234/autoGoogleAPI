# googledfareportingv25beta1.auto
...
```r
library(googleAuthR)
library(googledfareportingv25beta1.auto)
...
gar_auth()
```
 See the documentation for the package starting at `?googledfareportingv25beta1.auto`
## Useage
