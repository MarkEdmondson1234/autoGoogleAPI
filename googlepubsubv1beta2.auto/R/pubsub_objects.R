...
#' @export
ModifyAckDeadlineRequest <- function(ackId = NULL, ackIds = NULL, ackDeadlineSeconds = NULL) {
    structure(list(ackId = ackId, ackIds = ackIds, ackDeadlineSeconds = ackDeadlineSeconds), 
