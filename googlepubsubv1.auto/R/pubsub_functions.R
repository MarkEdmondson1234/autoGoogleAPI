...
#' @family SetIamPolicyRequest functions
#' @export
projects.snapshots.setIamPolicy <- function(SetIamPolicyRequest, resource) {
    url <- sprintf("https://pubsub.googleapis.com/v1/{+resource}:setIamPolicy", resource)
...
#' @family TestIamPermissionsRequest functions
#' @export
projects.snapshots.testIamPermissions <- function(TestIamPermissionsRequest, resource) {
    url <- sprintf("https://pubsub.googleapis.com/v1/{+resource}:testIamPermissions", 
        resource)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
projects.snapshots.getIamPolicy <- function(resource) {
    url <- sprintf("https://pubsub.googleapis.com/v1/{+resource}:getIamPolicy", resource)
