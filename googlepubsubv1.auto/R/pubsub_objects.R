...
#' @export
Subscription <- function(topic = NULL, pushConfig = NULL, ackDeadlineSeconds = NULL, 
    name = NULL) {
    structure(list(topic = topic, pushConfig = pushConfig, ackDeadlineSeconds = ackDeadlineSeconds, 
        name = name), class = "gar_Subscription")
}
...
#' @export
ModifyAckDeadlineRequest <- function(ackDeadlineSeconds = NULL, ackIds = NULL) {
    structure(list(ackDeadlineSeconds = ackDeadlineSeconds, ackIds = ackIds), class = "gar_ModifyAckDeadlineRequest")
}
