...
#' @family Account functions
#' @export
Account.childLink <- function(href = NULL, type = NULL) {
...
#' @param childLink No description
...
#' @param importBehavior No description
...
#' @param type Type of the custom data source
#' @param updated Time this custom data source was last modified
#' @param uploadType No description
...
CustomDataSource <- function(CustomDataSource.childLink = NULL, CustomDataSource.parentLink = NULL, 
    ...
    selfLink = NULL, type = NULL, updated = NULL, uploadType = NULL, webPropertyId = NULL) {
...
#' @family CustomDataSource functions
#' @export
CustomDataSource.childLink <- function(href = NULL, type = NULL) {
...
#' @family CustomDataSource functions
#' @export
CustomDataSource.parentLink <- function(href = NULL, type = NULL) {
...
#' @family CustomDimension functions
#' @export
CustomDimension.parentLink <- function(href = NULL, type = NULL) {
...
CustomMetric <- function(CustomMetric.parentLink = NULL, accountId = NULL, active = NULL, 
    ...
    scope = NULL, type = NULL, webPropertyId = NULL) {
...
#' @family CustomMetric functions
#' @export
CustomMetric.parentLink <- function(href = NULL, type = NULL) {
...
#' 
#' @param webPropertyRef No description
#' 
...
#' @family Experiment functions
#' @export
Experiment.parentLink <- function(href = NULL, type = NULL) {
...
Filter <- function(Filter.advancedDetails = NULL, Filter.lowercaseDetails = NULL, 
    ...
    type = NULL, uppercaseDetails = NULL) {
...
#' @family Filter functions
#' @export
Filter.parentLink <- function(href = NULL, type = NULL) {
...
#' @param GaData.dataTable.rows The \link{GaData.dataTable.rows} object or list of objects
#' @param GaData.dataTable.rows.c The \link{GaData.dataTable.rows.c} object or list of objects
#' @param cols No description
#' @param rows No description
#' 
...
Goal <- function(Goal.eventDetails = NULL, Goal.eventDetails.eventConditions = NULL, 
    ...
    name = NULL, parentLink = NULL, profileId = NULL, selfLink = NULL, type = NULL, 
    updated = NULL, urlDestinationDetails = NULL, value = NULL, visitNumPagesDetails = NULL, 
    visitTimeOnSiteDetails = NULL, webPropertyId = NULL) {
...
#' @family Goal functions
#' @export
Goal.parentLink <- function(href = NULL, type = NULL) {
...
#' 
#' @family IncludeConditions functions
#' @export
IncludeConditions <- function(daysToLookBack = NULL, isSmartList = NULL, membershipDurationDays = NULL, 
    segment = NULL) {
    structure(list(daysToLookBack = daysToLookBack, isSmartList = isSmartList, kind = `analytics#includeConditions`, 
        membershipDurationDays = membershipDurationDays, segment = segment), class = "gar_IncludeConditions")
}

#' LinkedForeignAccount Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' JSON template for an Analytics Remarketing Audience Foreign Link.
#' 
#' @param accountId Account ID to which this linked foreign account belongs
#' @param id Entity ad account link ID
#' @param linkedAccountId The foreign account ID
#' @param remarketingAudienceId Remarketing audience ID to which this linked foreign account belongs
#' @param status The status of this foreign account link
#' @param type The type of the foreign account
#' @param webPropertyId Web property ID of the form UA-XXXXX-YY to which this linked foreign account belongs
#' 
#' @return LinkedForeignAccount object
#' 
#' @family LinkedForeignAccount functions
#' @export
LinkedForeignAccount <- function(accountId = NULL, id = NULL, linkedAccountId = NULL, 
    remarketingAudienceId = NULL, status = NULL, type = NULL, webPropertyId = NULL) {
    structure(list(accountId = accountId, id = id, kind = `analytics#linkedForeignAccount`, 
        linkedAccountId = linkedAccountId, remarketingAudienceId = remarketingAudienceId, 
        status = status, type = type, webPropertyId = webPropertyId), class = "gar_LinkedForeignAccount")
}
...
Profile <- function(Profile.childLink = NULL, Profile.parentLink = NULL, Profile.permissions = NULL, 
    ...
    timezone = NULL, type = NULL, websiteUrl = NULL) {
...
#' @family Profile functions
#' @export
Profile.childLink <- function(href = NULL, type = NULL) {
...
#' @family Profile functions
#' @export
Profile.parentLink <- function(href = NULL, type = NULL) {
...
#' @export
ProfileSummary <- function(id = NULL, name = NULL, starred = NULL, type = NULL) {
...
RealtimeData.query <- function(dimensions = NULL, filters = NULL, ids = NULL, max.results = NULL, 
    ...
    structure(list(dimensions = dimensions, filters = filters, ids = ids, `max-results` = max.results, 
        metrics = metrics, sort = sort), class = "gar_RealtimeData.query")
}
...
#' RemarketingAudience.audienceDefinition Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' The simple audience definition that will cause a user to be added to an audience.
#' 
#' @param includeConditions Defines the conditions to include users to the audience
#' 
#' @return RemarketingAudience.audienceDefinition object
#' 
#' @family RemarketingAudience functions
#' @export
RemarketingAudience.audienceDefinition <- function(includeConditions = NULL) {
    structure(list(includeConditions = includeConditions), class = "gar_RemarketingAudience.audienceDefinition")
}

#' RemarketingAudience.stateBasedAudienceDefinition Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
...
#' 
#' @param RemarketingAudience.stateBasedAudienceDefinition.excludeConditions The \link{RemarketingAudience.stateBasedAudienceDefinition.excludeConditions} object or list of objects
#' @param excludeConditions Defines the conditions to exclude users from the audience
#' @param includeConditions Defines the conditions to include users to the audience
#' 
#' @return RemarketingAudience.stateBasedAudienceDefinition object
#' 
#' @family RemarketingAudience functions
#' @export
RemarketingAudience.stateBasedAudienceDefinition <- function(RemarketingAudience.stateBasedAudienceDefinition.excludeConditions = NULL, 
    excludeConditions = NULL, includeConditions = NULL) {
    structure(list(RemarketingAudience.stateBasedAudienceDefinition.excludeConditions = RemarketingAudience.stateBasedAudienceDefinition.excludeConditions, 
        excludeConditions = excludeConditions, includeConditions = includeConditions), 
        class = "gar_RemarketingAudience.stateBasedAudienceDefinition")
}

#' RemarketingAudience.stateBasedAudienceDefinition.excludeConditions Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' Defines the conditions to exclude users from the audience.
#' 
#' @param exclusionDuration Whether to make the exclusion TEMPORARY or PERMANENT
#' @param segment The segment condition that will cause a user to be removed from an audience
#' 
#' @return RemarketingAudience.stateBasedAudienceDefinition.excludeConditions object
#' 
#' @family RemarketingAudience functions
#' @export
RemarketingAudience.stateBasedAudienceDefinition.excludeConditions <- function(exclusionDuration = NULL, 
    segment = NULL) {
    structure(list(exclusionDuration = exclusionDuration, segment = segment), class = "gar_RemarketingAudience.stateBasedAudienceDefinition.excludeConditions")
}

#' RemarketingAudiences Object
#' 
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
...
#' 
#' @param items A list of remarketing audiences
#' @param itemsPerPage The maximum number of resources the response can contain, regardless of the actual number of resources returned
#' @param nextLink Link to next page for this remarketing audience collection
#' @param previousLink Link to previous page for this view (profile) collection
#' @param startIndex The starting index of the resources, which is 1 by default or otherwise specified by the start-index query parameter
#' @param totalResults The total number of results for the query, regardless of the number of results in the response
#' @param username Email ID of the authenticated user
#' 
#' @return RemarketingAudiences object
#' 
#' @family RemarketingAudiences functions
#' @export
RemarketingAudiences <- function(items = NULL, itemsPerPage = NULL, nextLink = NULL, 
    previousLink = NULL, startIndex = NULL, totalResults = NULL, username = NULL) {
    structure(list(items = items, itemsPerPage = itemsPerPage, kind = `analytics#remarketingAudiences`, 
        nextLink = nextLink, previousLink = previousLink, startIndex = startIndex, 
        totalResults = totalResults, username = username), class = "gar_RemarketingAudiences")
}
...
Segment <- function(created = NULL, definition = NULL, id = NULL, name = NULL, segmentId = NULL, 
    selfLink = NULL, type = NULL, updated = NULL) {
...
UnsampledReport <- function(UnsampledReport.cloudStorageDownloadDetails = NULL, UnsampledReport.driveDownloadDetails = NULL, 
    ...
    structure(list(UnsampledReport.cloudStorageDownloadDetails = UnsampledReport.cloudStorageDownloadDetails, 
        ...
        accountId = accountId, dimensions = dimensions, `end-date` = end.date, filters = filters, 
        id = id, metrics = metrics, profileId = profileId, segment = segment, `start-date` = start.date, 
        title = title, webPropertyId = webPropertyId), class = "gar_UnsampledReport")
}
...
#' @family Webproperty functions
#' @export
Webproperty.childLink <- function(href = NULL, type = NULL) {
...
#' @family Webproperty functions
#' @export
Webproperty.parentLink <- function(href = NULL, type = NULL) {
