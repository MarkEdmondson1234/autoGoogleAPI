...
#' @export
ClusterConfiguration <- function(configurationBucket = NULL, gceClusterConfiguration = NULL, 
    masterConfiguration = NULL, workerConfiguration = NULL, secondaryWorkerConfiguration = NULL, 
    softwareConfiguration = NULL, initializationActions = NULL) {
    structure(list(configurationBucket = configurationBucket, gceClusterConfiguration = gceClusterConfiguration, 
...
Job <- function(reference = NULL, placement = NULL, hadoopJob = NULL, sparkJob = NULL, 
    ...
    statusHistory = NULL, yarnApplications = NULL, submittedBy = NULL, driverInputResourceUri = NULL, 
    driverOutputResourceUri = NULL, driverControlFilesUri = NULL, interactive = NULL) {
    structure(list(reference = reference, placement = placement, hadoopJob = hadoopJob, 
        ...
        yarnApplications = yarnApplications, submittedBy = submittedBy, driverInputResourceUri = driverInputResourceUri, 
        driverOutputResourceUri = driverOutputResourceUri, driverControlFilesUri = driverControlFilesUri, 
        interactive = interactive), class = "gar_Job")
}
