...
#' @importFrom googleAuthR gar_api_generator
#' @export
backendBuckets.delete <- function(project, backendBucket) {
...
#' @export
backendBuckets.insert <- function(BackendBucket, project) {
...
#' @family BackendBucket functions
#' @export
backendBuckets.patch <- function(BackendBucket, project, backendBucket) {
    url <- sprintf("https://www.googleapis.com/compute/alpha/projects/%s/global/backendBuckets/%s", 
        backendBucket, project)
...
#' @family BackendBucket functions
#' @export
backendBuckets.update <- function(BackendBucket, project, backendBucket) {
    url <- sprintf("https://www.googleapis.com/compute/alpha/projects/%s/global/backendBuckets/%s", 
        backendBucket, project)
...
disks.createSnapshot <- function(Snapshot, project, zone, disk, guestFlush = NULL) {
    ...
    f <- gar_api_generator(url, "POST", pars_args = list(guestFlush = guestFlush), 
        data_parse_function = function(x) x)
...
#' @export
disks.setLabels <- function(ZoneSetLabelsRequest, project, zone, resource) {
...
#' @param start For the initial request, leave this field unspecified
#' @importFrom googleAuthR gar_api_generator
#' @export
instances.getSerialPortOutput <- function(project, zone, instance, port = NULL, start = NULL) {
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(port = port, start = start), 
        data_parse_function = function(x) x)
    f()
...
#' @importFrom googleAuthR gar_api_generator
#' @export
instances.stop <- function(project, zone, instance, discardLocalSsd = NULL) {
    url <- sprintf("https://www.googleapis.com/compute/alpha/projects/%s/zones/%s/instances/%s/stop", 
        instance, project, zone)
    # compute.instances.stop
    f <- gar_api_generator(url, "POST", pars_args = list(discardLocalSsd = discardLocalSsd), 
        data_parse_function = function(x) x)
    f()
...
#' @importFrom googleAuthR gar_api_generator
#' @export
instances.suspend <- function(project, zone, instance, discardLocalSsd = NULL) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
projects.disableXpnHost <- function(project) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
projects.enableXpnHost <- function(project) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
projects.getXpnResources <- function(project) {
...
#' @export
projects.listXpnHosts <- function(ProjectsListXpnHostsRequest, project) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
regionDisks.delete <- function(project, region, disk) {
...
#' @family Disk functions
#' @export
regionDisks.insert <- function(Disk, project, region, sourceImage = NULL) {
...
#' @export
regionDisks.resize <- function(RegionDisksResizeRequest, project, region, disk) {
