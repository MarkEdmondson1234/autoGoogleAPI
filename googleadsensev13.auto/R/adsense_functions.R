...
#'  at 2016-09-03 22:33:14
#' filename: /Users/mark/dev/R/autoGoogleAPI/googleadsensev13.auto/R/adsense_functions.R
#' api_json: api_json
#' 
#' @details 
...
accounts.get <- function(accountId, tree = NULL) {
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/accounts/%s", accountId)
...
adunits.get <- function(adClientId, adUnitId) {
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/adclients/%s/adunits/%s", 
        adClientId, adUnitId)
    # adsense.adunits.get
...
adunits.getAdCode <- function(adClientId, adUnitId) {
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/adclients/%s/adunits/%s/adcode", 
        adClientId, adUnitId)
...
adunits.list <- function(adClientId, includeInactive = NULL, maxResults = NULL, pageToken = NULL) {
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/adclients/%s/adunits", 
        adClientId)
...
customchannels.get <- function(adClientId, customChannelId) {
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/adclients/%s/customchannels/%s", 
...
customchannels.list <- function(adClientId, maxResults = NULL, pageToken = NULL) {
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/adclients/%s/customchannels", 
        adClientId)
...
savedadstyles.get <- function(savedAdStyleId) {
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/savedadstyles/%s", savedAdStyleId)
...
urlchannels.list <- function(adClientId, maxResults = NULL, pageToken = NULL) {
    ...
    url <- sprintf("https://www.googleapis.com/adsense/v1.3/adclients/%s/urlchannels", 
        adClientId)
