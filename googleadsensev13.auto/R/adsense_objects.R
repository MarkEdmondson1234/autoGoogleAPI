...
#'  at 2017-03-05 19:23:34
#' filename: /Users/mark/dev/R/autoGoogleAPI/googleadsensev13.auto/R/adsense_objects.R
#' api_json: api_json
#' 
...
#' @export
Account <- function(id = NULL, name = NULL, premium = NULL, subAccounts = NULL) {
    structure(list(id = id, kind = `adsense#account`, name = name, premium = premium, 
        subAccounts = subAccounts), class = "gar_Account")
}
...
AdsenseReportsGenerateResponse <- function(AdsenseReportsGenerateResponse.headers = NULL, 
    averages = NULL, headers = NULL, rows = NULL, totalMatchedRows = NULL, totals = NULL, 
    warnings = NULL) {
    structure(list(AdsenseReportsGenerateResponse.headers = AdsenseReportsGenerateResponse.headers, 
        averages = averages, headers = headers, kind = `adsense#report`, rows = rows, 
        totalMatchedRows = totalMatchedRows, totals = totals, warnings = warnings), 
        class = "gar_AdsenseReportsGenerateResponse")
}
...
Alert <- function(id = NULL, message = NULL, severity = NULL, type = NULL) {
    structure(list(id = id, kind = `adsense#alert`, message = message, severity = severity, 
