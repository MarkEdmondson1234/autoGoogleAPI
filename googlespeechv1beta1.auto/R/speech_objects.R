...
#' @export
RecognitionAudio <- function(content = NULL, uri = NULL) {
    structure(list(content = content, uri = uri), class = "gar_RecognitionAudio")
}
...
#' @export
SpeechRecognitionAlternative <- function(transcript = NULL, confidence = NULL) {
    structure(list(transcript = transcript, confidence = confidence), class = "gar_SpeechRecognitionAlternative")
}
...
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' The `RecognitionConfig` message provides information to the recognizerthat specifies how to process the request.
#' 
...
#' @param audioChannels [Optional] The number of interleaved channels in the input audio data
#' 
#' @return RecognitionConfig object
#' 
#' @family RecognitionConfig functions
#' @export
RecognitionConfig <- function(maxAlternatives = NULL, languageCode = NULL, speechContext = NULL, 
    encoding = NULL, profanityFilter = NULL, sampleRate = NULL, audioChannels = NULL) {
    structure(list(maxAlternatives = maxAlternatives, languageCode = languageCode, 
        speechContext = speechContext, encoding = encoding, profanityFilter = profanityFilter, 
        sampleRate = sampleRate, audioChannels = audioChannels), class = "gar_RecognitionConfig")
}
...
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' `SyncRecognizeRequest` is the top-level message sent by the client forthe `SyncRecognize` method.
#' 
...
#' @export
SyncRecognizeRequest <- function(audio = NULL, config = NULL) {
    structure(list(audio = audio, config = config), class = "gar_SyncRecognizeRequest")
}
...
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' `SyncRecognizeResponse` is the only message returned to the client by`SyncRecognize`. It contains the result as zero or more sequential`SpeechRecognitionResult` messages.
#' 
...
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' `AsyncRecognizeRequest` is the top-level message sent by the client forthe `AsyncRecognize` method.
#' 
#' @param audio [Required] The audio data to be recognized
#' @param config [Required] The `config` message provides information to the recognizer
#' 
...
AsyncRecognizeRequest <- function(audio = NULL, config = NULL) {
    
    
    
    structure(list(audio = audio, config = config), class = "gar_AsyncRecognizeRequest")
}
