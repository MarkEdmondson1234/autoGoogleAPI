...
#' @export
DatabaseInstance <- function(currentDiskSize = NULL, databaseVersion = NULL, etag = NULL, 
    instance = NULL, instanceType = NULL, ipAddresses = NULL, ipv6Address = NULL, 
    ...
    structure(list(currentDiskSize = currentDiskSize, databaseVersion = databaseVersion, 
        etag = etag, instance = instance, instanceType = instanceType, ipAddresses = ipAddresses, 
        ipv6Address = ipv6Address, kind = `sql#instance`, masterInstanceName = masterInstanceName, 
        maxDiskSize = maxDiskSize, project = project, region = region, replicaNames = replicaNames, 
        serverCaCert = serverCaCert, serviceAccountEmailAddress = serviceAccountEmailAddress, 
        settings = settings, state = state), class = "gar_DatabaseInstance")
}
