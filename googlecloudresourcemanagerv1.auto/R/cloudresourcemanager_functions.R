...
projects.getAncestry <- function(GetAncestryRequest, projectId) {
    url <- sprintf("https://cloudresourcemanager.googleapis.com/v1/projects/%s:getAncestry", 
        projectId)
...
organizations.setIamPolicy <- function(SetIamPolicyRequest, resource) {
    url <- sprintf("https://cloudresourcemanager.googleapis.com/v1/{+resource}:setIamPolicy", 
        resource)
...
organizations.testIamPermissions <- function(TestIamPermissionsRequest, resource) {
    url <- sprintf("https://cloudresourcemanager.googleapis.com/v1/{+resource}:testIamPermissions", 
        resource)
...
organizations.getIamPolicy <- function(GetIamPolicyRequest, resource) {
    url <- sprintf("https://cloudresourcemanager.googleapis.com/v1/{+resource}:getIamPolicy", 
        resource)
...
#' Searches Organization resources that are visible to the user and satisfythe specified filter. This method returns Organizations in an unspecifiedorder. New Organizations do not necessarily appear at the end of theresults.
#' 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#' 
#' @seealso \href{https://cloud.google.com/resource-manager}{Google Documentation}
...
#' See \code{\link[googleAuthR]{gar_auth}} for details. 
#' 
#' @param SearchOrganizationsRequest The \link{SearchOrganizationsRequest} object to pass to this method
#' #' @importFrom googleAuthR gar_api_generator
#' @family SearchOrganizationsRequest functions
#' @export
organizations.search <- function(SearchOrganizationsRequest) {
    url <- "https://cloudresourcemanager.googleapis.com/v1/organizations:search"
    # cloudresourcemanager.organizations.search
    f <- googleAuthR::gar_api_generator(url, "POST", data_parse_function = function(x) x)
    stopifnot(inherits(SearchOrganizationsRequest, "gar_SearchOrganizationsRequest"))
    
    f(the_body = SearchOrganizationsRequest)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
organizations.get <- function(name) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details. 
#' 
#' @param parent The name of the resource to list all attached Liens
...
#' @importFrom googleAuthR gar_api_generator
#' @export
liens.list <- function(parent = NULL, pageToken = NULL, pageSize = NULL) {
    url <- "https://cloudresourcemanager.googleapis.com/v1/liens"
    # cloudresourcemanager.liens.list
    pars = list(parent = parent, pageToken = pageToken, pageSize = pageSize)
    f <- googleAuthR::gar_api_generator(url, "GET", pars_args = rmNullObs(pars), 
        data_parse_function = function(x) x)
    f()
...
#' See \code{\link[googleAuthR]{gar_auth}} for details. 
#' 
#' @param Lien The \link{Lien} object to pass to this method
#' #' @importFrom googleAuthR gar_api_generator
#' @family Lien functions
#' @export
liens.create <- function(Lien) {
    url <- "https://cloudresourcemanager.googleapis.com/v1/liens"
    # cloudresourcemanager.liens.create
    f <- googleAuthR::gar_api_generator(url, "POST", data_parse_function = function(x) x)
    stopifnot(inherits(Lien, "gar_Lien"))
