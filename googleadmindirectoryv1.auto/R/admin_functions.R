...
directory.chromeosdevices.list <- function(customerId, maxResults = NULL, orderBy = NULL, 
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(maxResults = maxResults, 
        orderBy = orderBy, pageToken = pageToken, projection = projection, query = query, 
...
directory.chromeosdevices.patch <- function(ChromeOsDevice, customerId, deviceId, 
    ...
    f <- gar_api_generator(url, "PATCH", pars_args = list(projection = projection), 
        data_parse_function = function(x) x)
...
directory.chromeosdevices.update <- function(ChromeOsDevice, customerId, deviceId, 
    ...
    f <- gar_api_generator(url, "PUT", pars_args = list(projection = projection), 
        data_parse_function = function(x) x)
    stopifnot(inherits(ChromeOsDevice, "gar_ChromeOsDevice"))
...
directory.domainAliases.list <- function(customer, parentDomainName = NULL) {
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(parentDomainName = parentDomainName), 
        data_parse_function = function(x) x)
    f()
...
directory.groups.list <- function(customer = NULL, domain = NULL, maxResults = NULL, 
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(customer = customer, domain = domain, 
        maxResults = maxResults, pageToken = pageToken, userKey = userKey), data_parse_function = function(x) x)
    f()
...
directory.members.list <- function(groupKey, maxResults = NULL, pageToken = NULL, 
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(maxResults = maxResults, 
        pageToken = pageToken, roles = roles), data_parse_function = function(x) x)
    f()
...
directory.orgunits.list <- function(customerId, orgUnitPath = NULL, type = NULL) {
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(orgUnitPath = orgUnitPath, 
        type = type), data_parse_function = function(x) x)
    f()
...
directory.roleAssignments.list <- function(customer, maxResults = NULL, pageToken = NULL, 
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(maxResults = maxResults, 
        pageToken = pageToken, roleId = roleId, userKey = userKey), data_parse_function = function(x) x)
    f()
...
directory.users.get <- function(userKey, customFieldMask = NULL, projection = NULL, 
    ...
    url <- sprintf("https://www.googleapis.com/admin/directory/v1/users/%s", userKey)
    # directory.users.get
    f <- gar_api_generator(url, "GET", pars_args = list(customFieldMask = customFieldMask, 
        projection = projection, viewType = viewType), data_parse_function = function(x) x)
    f()
...
directory.users.list <- function(customFieldMask = NULL, customer = NULL, domain = NULL, 
    ...
    f <- gar_api_generator(url, "GET", pars_args = list(customFieldMask = customFieldMask, 
        customer = customer, domain = domain, event = event, maxResults = maxResults, 
        orderBy = orderBy, pageToken = pageToken, projection = projection, query = query, 
        showDeleted = showDeleted, sortOrder = sortOrder, viewType = viewType), data_parse_function = function(x) x)
    f()
...
directory.users.watch <- function(Channel, customFieldMask = NULL, customer = NULL, 
    ...
    f <- gar_api_generator(url, "POST", pars_args = list(customFieldMask = customFieldMask, 
        customer = customer, domain = domain, event = event, maxResults = maxResults, 
        orderBy = orderBy, pageToken = pageToken, projection = projection, query = query, 
        showDeleted = showDeleted, sortOrder = sortOrder, viewType = viewType), data_parse_function = function(x) x)
    stopifnot(inherits(Channel, "gar_Channel"))
