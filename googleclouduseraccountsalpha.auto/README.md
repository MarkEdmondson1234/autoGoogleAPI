# googleclouduseraccountsalpha.auto
...
```r
library(googleAuthR)
library(googleclouduseraccountsalpha.auto)
...
gar_auth()
```
 See the documentation for the package starting at `?googleclouduseraccountsalpha.auto`
## Useage
